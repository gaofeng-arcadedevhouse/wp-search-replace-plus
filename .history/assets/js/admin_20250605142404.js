    ...
    var WTSR = {
        ...
        testAjaxConnection: function(e) {
            ...
            $.post(wtsr_ajax.ajax_url, {
                action: 'heartbeat',
                _wpnonce: wtsr_ajax.nonce
            })
            .done(function(response) {
                console.log('WTSR: Heartbeat response:', response);
                self.showMessage('AJAX连接测试成功', 'success');
            })
            .fail(function(xhr, status, error) {
                console.error('WTSR: Heartbeat failed:', xhr, status, error);
                self.showMessage('AJAX连接测试失败: ' + status + ' - ' + error, 'error');
            });
        },
