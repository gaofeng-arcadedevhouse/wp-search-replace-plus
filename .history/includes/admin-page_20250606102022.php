                        ...
                        <td>
                            <fieldset>
                                ...
                                if (isset($all_post_types['widgets'])) {
                                    ...
                                    error_log('WTSR: Widgets post type NOT found');
                                ...
                                <label for="<?php echo esc_attr($checkbox_id); ?>">
                                    <input type="checkbox" id="<?php echo esc_attr($checkbox_id); ?>" name="search_scope[]" value="<?php echo esc_attr($checkbox_value); ?>" <?php echo ($post_type_name === 'widgets') ? 'checked' : ''; ?>>
