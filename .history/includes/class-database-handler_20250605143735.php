    ...
    public function search($search_text, $search_scope, $options) {
        ...
        try {
            ...
            if (in_array('posts', $search_scope) || in_array('pages', $search_scope)) {
                ...
                $post_results = $this->searchPosts($search_text, $post_types, $options);
            ...
            if (in_array('acf', $search_scope)) {
                ...
                $acf_results = $this->searchACFFields($search_text, $options);
            ...
            if (in_array('meta', $search_scope)) {
                ...
                $meta_results = $this->searchPostMeta($search_text, $options);
            ...
            if (in_array('comments', $search_scope)) {
                ...
                $comment_results = $this->searchComments($search_text, $options);
