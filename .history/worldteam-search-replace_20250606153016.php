...
class WorldTeamSearchReplace {
    ...
    public function enqueueScripts($hook) {
        ...
        wp_enqueue_script('wtsr-search', WTSR_PLUGIN_URL . 'assets/js/search.js', array('jquery'), WTSR_VERSION, true);
        wp_enqueue_style('wtsr-search', WTSR_PLUGIN_URL . 'assets/css/search.css', array(), WTSR_VERSION);
