                        ...
                        <td>
                            <fieldset>
                                ...
                                <label for="search_meta">
                                    <input type="checkbox" id="search_meta" name="search_scope[]" value="meta" checked>
                                    <?php _e('Custom Fields', 'worldteam-search-replace'); ?>
                                </label><br>
                                
                                <label for="search_comments">
                                    <input type="checkbox" id="search_comments" name="search_scope[]" value="comments" checked>
                                    <?php _e('Comments Content', 'worldteam-search-replace'); ?>
                                </label><br>
                                
                                <h4><?php _e('File System', 'worldteam-search-replace'); ?></h4>
                                <label for="search_theme">
                                    <input type="checkbox" id="search_theme" name="search_scope[]" value="theme" checked>
                                    <?php _e('Theme Files (PHP files only)', 'worldteam-search-replace'); ?>
                                </label>
                            </fieldset>
                        </td>
                    </tr>
